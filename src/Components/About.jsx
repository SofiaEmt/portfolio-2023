        ...
        <section className="about">
            ...
            <div className='facts'>
                <div className='facts_title'></div>
                    <p className='van'>Transformed and rebuilt a van into a <span>camper</span> and roadtripped through Europe</p>
                    <p className='sauna'>Regularly <span>sauna</span> bathes!</p>
                    <p className='fun'>Am quite the fun coworker!</p>
            </div>
